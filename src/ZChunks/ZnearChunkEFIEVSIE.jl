...
"""
function calZnearChunksCFIE!(cubes, geosInfo1::AbstractVector{T1}, geosInfo2::AbstractVector{T2},
    ...
    cond = true
    if cond
        pmeter = Progress(length(idcs); desc = "Cal Z on rank $(ZnearChunks)...", dt = 1, barglyphs=BarGlyphs("[=> ]"), color = :blue)
    end
    # 计算
